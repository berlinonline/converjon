...
if (process.env.NODE_ENV !== "production") {
    try {
        fsUtils.rmdirSyncRecursive(config.imageFetcher.cache.sourceBasePath);
        fsUtils.rmdirSyncRecursive(config.imageFetcher.cache.targetBasePath);
    } catch (e) {
...
fsUtils.makeDirRecursive(config.imageFetcher.cache.sourceBasePath);
fsUtils.makeDirRecursive(config.imageFetcher.cache.targetBasePath);
