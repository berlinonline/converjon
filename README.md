...
*Converjon 2.0.0 is not yet released but can be downloaded for testing. Clone this repository and run `npm install -g <path_to_repository>` to install it since it is not yet published to npmjs.org*
